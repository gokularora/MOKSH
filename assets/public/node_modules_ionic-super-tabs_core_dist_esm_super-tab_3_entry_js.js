(self["webpackChunkmoksh_mobility_app"] = self["webpackChunkmoksh_mobility_app"] || []).push([["node_modules_ionic-super-tabs_core_dist_esm_super-tab_3_entry_js"],{
...
class SuperTabComponent {
    ...
    render() {
        return (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null);
    }
...
class SuperTabsComponent {
    constructor(hostRef) {
        ...
        this.tabChange = (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "tabChange", 7);
    }
    /**
     ...
     */
    debug(...vals) {
        (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.d)(this._config, 'tabs', vals);
    }
    render() {
        // Render 3 slots
        ...
        return ((0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: "top" }), (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null), (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: "bottom" })));
    }
    get el() { return (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.g)(this); }
...
class SuperTabsContainerComponent {
    constructor(hostRef) {
        ...
        this.scrollWidth = 0;
        this.width = 0;
        this.activeTabIndexChange = (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "activeTabIndexChange", 7);
        this.selectedTabIndexChange = (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "selectedTabIndexChange", 7);
        this.queue = (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.d)(this, "queue");
    }
    ...
    moveContainer(scrollX, animate) {
        if (animate) {
            (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.s)(this.el, scrollX, 0, this.config.nativeSmoothScroll, this.config.transitionDuration);
        }
        else {
    ...
    async scrollToTop() {
        ...
        if (el) {
            (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.s)(el, 0, 0, this.config.nativeSmoothScroll, this.config.transitionDuration);
        }
        else {
    ...
    async onTouchStart(ev) {
        ...
        if (this.config.shortSwipeDuration > 0) {
            this.initialTimestamp = (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.a)();
        }
    ...
    async onTouchMove(ev) {
        ...
        const coords = (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.p)(ev);
        if (!this.isDragging) {
            if (!(0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.c)(coords, this.initialCoords, this.config)) {
    ...
    async onTouchEnd(ev) {
        ...
        const coords = (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.p)(ev);
        const deltaTime = (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.a)() - this.initialTimestamp;
     ...
     */
    debug(...vals) {
        (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.d)(this.config, 'container', vals);
    }
    render() {
        return (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null);
    }
