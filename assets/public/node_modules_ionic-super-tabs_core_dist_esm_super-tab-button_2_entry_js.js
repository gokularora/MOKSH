(self["webpackChunkmoksh_mobility_app"] = self["webpackChunkmoksh_mobility_app"] || []).push([["node_modules_ionic-super-tabs_core_dist_esm_super-tab-button_2_entry_js"],{
...
/* harmony export */ });
/* harmony import */ var _index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-a34c410e.js */ 52827);
/* harmony import */ var _utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils-640d2cf5.js */ 63993);
...
class SuperTabButtonComponent {
    constructor(hostRef) {
        (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.r)(this, hostRef);
        /**
    ...
    render() {
        return ((0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.H, { role: "button", "aria-label": this.label ? this.label.innerText : false, "aria-disabled": this.disabled ? 'true' : false, "aria-selected": this.active ? 'true' : 'false', class: {
            ...
            } }, (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null), (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", { type: "unbounded" })));
    }
    get el() { return (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.g)(this); }
}
...
class SuperTabsToolbarComponent {
    constructor(hostRef) {
        ...
        this.hostCls = {};
        this.buttonClick = (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "buttonClick", 7);
    }
    ...
    moveContainer(scrollX, animate) {
        ...
        (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.s)(this.buttonsContainerEl, scrollX, 0, this.config.nativeSmoothScroll, animate ? this.config.transitionDuration : 0);
        return Promise.resolve();
    }
    getButtonFromEv(ev) {
    ...
    async onTouchStart(ev) {
        ...
        const coords = (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.p)(ev);
        const vw = this.width;
    ...
    async onTouchMove(ev) {
        ...
        const coords = (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.p)(ev);
        if (!this.isDragging) {
            const shouldCapture = (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.c)(coords, this.initialCoords, this.config);
            if (!shouldCapture) {
        ...
        requestAnimationFrame(() => {
            ...
            // scroll container
            const scrollX = (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.g)(this.buttonsContainerEl, this.buttonsContainerEl.clientWidth, deltaX);
    ...
    adjustContainerScroll(animate) {
        ...
        if (!animate) {
            (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.s)(this.buttonsContainerEl, pos, 0, false, 50);
        }
        else {
     ...
     */
    debug(...vals) {
        (0,_utils_640d2cf5_js__WEBPACK_IMPORTED_MODULE_1__.d)(this.config, 'toolbar', vals);
    }
    render() {
        return ((0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.H, { role: "navigation", class: this.hostCls }, (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "buttons-container", ref: (ref) => this.setButtonsContainerEl(ref) }, (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null), this.showIndicator &&
            (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.h)("super-tab-indicator", { ref: (ref) => this.indicatorEl = ref, toolbarPosition: this.el.assignedSlot.name }))));
    }
    get el() { return (0,_index_a34c410e_js__WEBPACK_IMPORTED_MODULE_0__.g)(this); }
